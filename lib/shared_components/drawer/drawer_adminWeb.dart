...
class DrawerAdminWeb extends StatelessWidget implements PreferredSizeWidget {
  DrawerAdminWeb({Key key}) : super(key: key);
  ...
  void _onItemTappedAdmin(int index, {DrawerAdminViewModel modelDrawer}) {
    ...
    switch (index) {
      ...
      case 7:
        ...
        break;
      // case 8:
      //   routeName = AllWatchlistViewRoute;
