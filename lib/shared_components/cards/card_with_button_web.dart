...
class CardWithButtonWeb extends StatefulWidget {
  final bool busy;
  final String title;
  ...
  @override
  _CardWithButtonWebState createState() => _CardWithButtonWebState();
}

class _CardWithButtonWebState extends State<CardWithButtonWeb> {
  @override
