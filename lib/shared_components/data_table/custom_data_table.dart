...
class CustomDataTable extends StatelessWidget {
    ...
    label = Container(
      ...
      child: DefaultTextStyle(
        style: TextStyle(
          ...
          fontSize: 13.0,
          color: isLightTheme
            ? (placeholder ? Colors.black38 :  AppTheme.instance.primaryFontColor)
            : (placeholder ? Colors.white38 :  AppTheme.instance.primaryFontColor),
        ),
  ...
  Widget build(BuildContext context) {
    ...
    final BoxDecoration _kSelectedDecoration = BoxDecoration(
      ...
      color: (Theme.of(context).brightness == Brightness.light) ? AppTheme.instance.tableBackground : AppTheme.instance.tableBackground,
    );
