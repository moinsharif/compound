...
import 'package:compound/modules/employees/employees_view_model.dart';
...
part 'employees_mobile.dart';

class EmployeesView extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return ScreenTypeLayout(
      mobile: _EmployeesMobile(),
      desktop: _EmployeesMobile(),
      tablet: _EmployeesMobile(),
    );
  }
}
