...
class ActivityLogMobileState extends StatefulWidget {
  @override
  _ActivityLogMobileStateState createState() => _ActivityLogMobileStateState();
}

class _ActivityLogMobileStateState extends State<ActivityLogMobileState> {
  ...
  ButtonsChoose _buttons(ActivityLogViewModel model) {
