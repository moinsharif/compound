...
class _EmployeesPayrollViewMobile extends StatefulWidget {
  @override
  __EmployeesPayrollViewMobileState createState() =>
      __EmployeesPayrollViewMobileState();
}

class __EmployeesPayrollViewMobileState
    extends State<_EmployeesPayrollViewMobile> {
  ...
  Widget _editWageButton({Function onPress}) {
    return Container(
        decoration: BoxDecoration(
            color: Color(0xFF6F6F6F), borderRadius: BorderRadius.circular(5.0)),
        child: InkWell(
          onTap: onPress,
          child: Container(
              padding: EdgeInsets.symmetric(vertical: 3.0, horizontal: 8.0),
              child: Text('Edit Wage',
                  style: AppTheme.instance.textStyleVerySmall(
