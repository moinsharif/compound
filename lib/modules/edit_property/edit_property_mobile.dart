...
class _EditPropertyMobile extends StatefulWidget {
  @override
  __EditPropertyMobileState createState() => __EditPropertyMobileState();
}

class __EditPropertyMobileState extends State<_EditPropertyMobile> {
