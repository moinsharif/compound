...
class __AllViolationMobileState extends StatefulWidget {
  @override
  ___AllViolationMobileStateState createState() =>
      ___AllViolationMobileStateState();
}

class ___AllViolationMobileStateState extends State<__AllViolationMobileState> {
        ...
        onModelReady: (model) {
          ...
          model.scrollController.addListener(() async {
            if (model.scrollController.position.maxScrollExtent -
              ...
              await model.loadMoreViolations();
            }
          });
        },
        builder: (context, model, child) => Container(
              child: StreamBuilder<List<String>>(
                  ...
                  builder: (context, snapshot) {
                                ...
                                children: [
                                  ...
                                  Flexible(
                                    child: ListView.builder(
                                      ...
                                      itemCount: model.violations.length,
                                      itemBuilder:
                                          (BuildContext context, int index) {
                                        return _violation(index,
                                            model.violations[index], model);
                                      },
                                    ),
                                  ),
                                ],
                    ...
                    //         .entries
                    //         .map((e) =>
                    //             _violation(e.key, e.value, model))
                    //         .toList(),
                    //   ),
                  }),
            ));
  ...
  Widget _properties(AllViolationViewModel model, BuildContext context) {
    return TypeAheadField(
      ...
      onSuggestionSelected: (PropertyModel suggestion) async {
        model.changeArrowPositionProperty(false);
        model.setTextController(suggestion.propertyName);
        ...
        Expanded(
          child: Column(
            children: [
              ...
              if (violation.unit != null && violation.unit != "")
                Column(
                  children: [
                    _infoViolation(
                        title: 'Unit: ', description: violation.unit),
                    SizedBox(
                      height: 5.0,
                    ),
                  ],
              ...
              _infoViolation(
                  ...
                  description:
                      model.formatDateRange(violation.createdAt.local())),
              SizedBox(
                height: 5.0,
              ),
              _infoViolation(
              ...
              Align(
                ...
                child: _infoViolationSummary(
                    title: '${Config.oneViolation} Type: ',
                    description: '${violation.violationType.join(", ")}.'),
              )
            ],
          ),
        ),
                  ...
                  .map((img) => CachedNetworkImage(
                        ...
                        imageBuilder: (context, imageProvider) =>
                            ProgressiveImage(
                                ...
                                thumbnail: NetworkImage(Config.logoUrl),
                                image: imageProvider,
...
class _Dots extends StatelessWidget {
  ...
  const _Dots(this.totalSlides, this.pageViewController);
  @override
  Widget build(BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      children: List.generate(
          this.totalSlides, (i) => _Dot(i, this.pageViewController)),
    );
  }
}
...
class _Dot extends StatelessWidget {
  ...
  _Dot(this.index, this.pageViewController);
  ...
  Widget build(BuildContext context) {
    ...
    Color color;
    BoxShadow boxShadow;
    if (this.pageViewController.page != null &&
        this.pageViewController.page >= index - 0.5 &&
        this.pageViewController.page < index + 0.5) {
      tamano = 15.0;
      color = AppTheme.instance.primaryDarkColorBlue;
      boxShadow = BoxShadow(
          ...
          blurRadius: 2,
          offset: Offset(1, 3));
    } else if (this.pageViewController.page == null && index == 0) {
      tamano = 15.0;
      color = AppTheme.instance.primaryDarkColorBlue;
      boxShadow = BoxShadow(
          color: Colors.black.withOpacity(0.3),
...
class _Slides extends StatefulWidget {
  ...
  const _Slides(this.slides, this.violation);
    ...
    return Container(
      child: Column(
        children: [
          ...
          if (widget.violation.images.length > 1)
            Padding(
              padding: const EdgeInsets.symmetric(vertical: 2.0),
              child: _Dots(widget.violation.images.length, pageViewController),
            ),
          if (widget.violation.images.length <= 1)
            Container(
              height: 20.0,
