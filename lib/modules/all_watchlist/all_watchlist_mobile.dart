...
class __AllWatchlistMobileState extends StatefulWidget {
  @override
  ___AllWatchlistMobileStateState createState() =>
      ___AllWatchlistMobileStateState();
}

class ___AllWatchlistMobileStateState extends State<__AllWatchlistMobileState> {
                        ...
                        : model.watchlists.length < 1
                            ...
                            : Column(
                                children: model.watchlists
                                    .map((WatchlistModel violation) => InkWell(
                                        onTap: () => null,
                                        child: _violation(violation, model)))
                                    .toList(),
                              ),
                  ],
                ),
